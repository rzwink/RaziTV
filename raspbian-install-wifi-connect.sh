...
install_wfc() {
    ...
    say "Detecting system architecture..."
    ...
    _wfc_version=$("$INSTALL_BIN_DIR/wifi-connect" --version || echo "Installed, but version check failed")

    say "Successfully installed WiFi Connect: $_wfc_version"
}
